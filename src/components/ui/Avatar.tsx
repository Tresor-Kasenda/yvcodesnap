...
export function Avatar({ src, alt, initials, size = 'md', className = '' }: AvatarProps) {
    ...
    return (
        <div
            className={`relative overflow-hidden rounded-full bg-linear-to-br from-blue-500 to-violet-500 flex items-center justify-center font-semibold text-white ${sizeClasses[size]} ${className}`}
        >
