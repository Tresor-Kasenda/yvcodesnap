              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <button onClick={() => alignSelection('left')} className="flex flex-col items-center gap-2 p-3 bg-neutral-100 dark:bg-white/5 hover:bg-neutral-200 dark:hover:bg-white/10 rounded-xl group transition-all" title="Align left" aria-label="Align left">
                    ...
                    <button onClick={() => alignSelection('center')} className="flex flex-col items-center gap-2 p-3 bg-neutral-100 dark:bg-white/5 hover:bg-neutral-200 dark:hover:bg-white/10 rounded-xl group transition-all" title="Align center" aria-label="Align center">
                    ...
                    <button onClick={() => alignSelection('right')} className="flex flex-col items-center gap-2 p-3 bg-neutral-100 dark:bg-white/5 hover:bg-neutral-200 dark:hover:bg-white/10 rounded-xl group transition-all" title="Align right" aria-label="Align right">
                    ...
                    <button onClick={() => alignSelection('top')} className="flex flex-col items-center gap-2 p-3 bg-neutral-100 dark:bg-white/5 hover:bg-neutral-200 dark:hover:bg-white/10 rounded-xl group transition-all" title="Align top" aria-label="Align top">
                    ...
                    <button onClick={() => alignSelection('middle')} className="flex flex-col items-center gap-2 p-3 bg-neutral-100 dark:bg-white/5 hover:bg-neutral-200 dark:hover:bg-white/10 rounded-xl group transition-all" title="Align middle" aria-label="Align middle">
                    ...
                    <button onClick={() => alignSelection('bottom')} className="flex flex-col items-center gap-2 p-3 bg-neutral-100 dark:bg-white/5 hover:bg-neutral-200 dark:hover:bg-white/10 rounded-xl group transition-all" title="Align bottom" aria-label="Align bottom">
                ...
                {selectedElementIds.length > 2 && (
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <button onClick={() => distributeSelection('horizontal')} className="flex items-center justify-center gap-2 py-3 bg-neutral-100 dark:bg-white/5 hover:bg-neutral-200 dark:hover:bg-white/10 rounded-xl group transition-all" title="Distribute horizontally" aria-label="Distribute horizontally">
                      ...
                      <button onClick={() => distributeSelection('vertical')} className="flex items-center justify-center gap-2 py-3 bg-neutral-100 dark:bg-white/5 hover:bg-neutral-200 dark:hover:bg-white/10 rounded-xl group transition-all" title="Distribute vertically" aria-label="Distribute vertically">
