...
const GROUP_CLASS =
  'flex items-center gap-0.5 dark:bg-white/5';
...
const PositionControls: React.FC<PositionControlsProps> = ({
  ...
  const horizontalOptions: Array<{
    ...
    { value: 'center', tooltip: 'Align horizontal center', Icon: AlignCenterHorizontal, ariaLabel: 'Align horizontal center' },
  ...
  const verticalOptions: Array<{
    ...
    { value: 'top', tooltip: 'Align top', Icon: AlignStartVertical, ariaLabel: 'Align top' },
    { value: 'middle', tooltip: 'Align vertical center', Icon: AlignCenterVertical, ariaLabel: 'Align vertical center' },
    { value: 'bottom', tooltip: 'Align bottom', Icon: AlignEndVertical, ariaLabel: 'Align bottom' },
  ];
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
        ...
        <div className={GROUP_CLASS}>
          {verticalOptions.map(({ value, tooltip, Icon, ariaLabel }) => {
